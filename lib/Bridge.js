...
const { subscribeEtl } = require("../example/config.js");
...
class Bridge extends EventEmitter {
    ...
    constructor(config = {}){
        ...
        this.mqttClient.on("message", (topic, message) => {
            ...
            if(this.config.logMessages){
                debug("routing from Topic MQTT:", topic, "- Message:", message, "- to Topic Kafka:", process.env.KAFKA_TOPIC);
            }
    ...
    _route(topic, message, routing){
        ...
        // set message as an valid kafka object
